...
suppressWarnings(
  ggplot(data=ets_modeling_data, aes(x=Date))+ geom_line(aes(y=oil_prices, color = 'Oil Prices'))+ geom_line(aes(y=`Auction Price €/tCO2`, color = 'Auction Prices' ))+geom_line(aes(y=ftse_price/100, color ='FTSE/100' ))+
          ggtitle("Auction Price, FTSE and Oil Price against Time")+
...
```{r}
eu_cor_frame<- ets_modeling_data |> select(`Auction Volume tCO2`, `Maximum Bid €/tCO2`,`Average volume bid per bidder`,
...
One of the first things that would have jumped out of the 
