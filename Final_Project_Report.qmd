...
However, the Durbin Watson statistic is 1.275 and we see significant autocorrelation. The next model, where we transform the variables using their respective lags
