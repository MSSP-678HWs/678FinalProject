...
Here we transform our model variables by subtracting their respective lags from their values:
...
We can see that this model is much better. We have an acceptable durbin watson test statistic now. What about the coefficients?
...
Let's repeat this procedure with
