...
oil_price_lag<- EU_only_auction$oil_price[1:length(EU_only_auction$oil_price)-1]
...
ftse_price_lag<- EU_only_auction$ftse_price[1:length(EU_only_auction$ftse_price)-1]
...
oil_price_lag<- DE_only_auction$oil_price[1:length(DE_only_auction$oil_price)-1]
oil_price_lag<- c(0,oil_price_lag)
DE_only_with_lag<- DE_only_with_lag |> mutate(
                                          oil_price_lag= oil_price_lag, .after= oil_price
)
...
ftse_price_lag<- DE_only_auction$ftse_price[1:length(DE_only_auction$ftse_price)-1]
ftse_price_lag<- c(0,ftse_price_lag)
DE_only_with_lag<- DE_only_with_lag |> mutate(
                                          ftse_price_lag= ftse_price_lag, .after= ftse_price
)
...
oil_price_lag<- PL_only_auction$oil_price[1:length(PL_only_auction$oil_price)-1]
oil_price_lag<- c(0,oil_price_lag)
PL_only_with_lag<- PL_only_with_lag |> mutate(
                                          oil_price_lag= oil_price_lag, .after= oil_price
)
...
ftse_price_lag<- PL_only_auction$ftse_price[1:length(PL_only_auction$ftse_price)-1]
ftse_price_lag<- c(0,ftse_price_lag)
PL_only_with_lag<- PL_only_with_lag |> mutate(
                                          ftse_price_lag= ftse_price_lag, .after= ftse_price
)
...
oil_price_lag<- EUAA_only_auction$oil_price[1:length(EUAA_only_auction$oil_price)-1]
oil_price_lag<- c(0,oil_price_lag)
EUAA_only_with_lag<- EUAA_only_with_lag |> mutate(
                                          oil_price_lag= oil_price_lag, .after= oil_price
)
...
ftse_price_lag<- EUAA_only_auction$ftse_price[1:length(EUAA_only_auction$ftse_price)-1]
ftse_price_lag<- c(0,ftse_price_lag)
EUAA_only_with_lag<- EUAA_only_with_lag |> mutate(
                                          ftse_price_lag= ftse_price_lag, .after= ftse_price
)
