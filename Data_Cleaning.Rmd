...
Have to join the lags for each subset to the whole data using joins by date and auction type. How much testing does this need?

Does adding stock prices also raise the DW statistic? For germany above, the oil price addition raises the DW test statistic, probably because its so correlated with prices. TO DO.
