...
```{r}
eu_no_pool_fit_log<- glm(`Auction Price €/tCO2`~lag+`Auction Volume tCO2`+ `Average bid size`+
...
```{r}
eu_cor_frame<- ets_with_rep_lag |> select(lag,`Auction Volume tCO2`, `Maximum Bid €/tCO2`,
                                    oil_price, ftse_price) 
